...
class_name DialogueOptionNodeAst extends NodeAst
...
## Example: DialogueOptionNodeAst.new("1", Vector2.ZERO, "Jonny", "Slurp some coffee.")
func _init(
	p_id: String = "",
	...
	type = DialogueAst.Type.DIALOGUE_OPTION
	id = p_id
	position = p_position
...
## Example: node.update("Jonny", "Slurp some coffee.")
