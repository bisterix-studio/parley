        ...
        <>
          <div class="xl:hidden mx-4 md:mx-0 mt-4 md:mt-0">
            <button
              ...
              class="bg-background-primary py-2 px-4 rounded border border-foreground-secondary/30 flex items-center hover:border-text-blue-500/80 transition-colors text-sm"
            >
              On this page
              <svg
          ...
          <div class="hidden xl:block xl:sticky xl:top-40">
            <div class="relative">
              <div
                ref={refMarker}
                class="marker w-[2px] text-blue-500 h-5 absolute top-0 opacity-0 transition-all"
              />
                    ...
                    {headings.map((heading) => {
                      return (
                        <li key={heading.id}>
                          <a
                            href={`#${heading.id}`}
                            class="block truncate transition-colors text-gray-600 [&.active]:text-blue-500"
                            onClick={() => {
                              setActiveLink(
                                ref.current!,
                                refMarker.current!,
